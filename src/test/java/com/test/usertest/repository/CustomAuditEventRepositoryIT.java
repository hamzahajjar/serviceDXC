...
import com.test.usertest.config.audit.AuditEventConverter;
import com.test.usertest.domain.PersistentAuditEvent;
...
import static com.test.usertest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
